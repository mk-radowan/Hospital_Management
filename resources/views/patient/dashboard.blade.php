                ...
                <div class="card-body">
                    @if ($upcomingAppointments->isEmpty())
                        <div class="text-center py-4">
                            ...
                            <a href="{{ route('patient.appointments.create') }}" class="btn btn-primary-custom">Book Your
                                First Appointment</a>
                        </div>
                    @else
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('patient.prescriptions.index') }}" class="btn btn-sm btn-outline-primary">View
                        All</a>
                </div>
                <div class="card-body">
                        ...
                        @foreach ($prescriptions->take(3) as $prescription)
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <small
                                        class="text-muted">{{ $prescription->prescription_date->format('M d, Y') }}</small>
                                </div>

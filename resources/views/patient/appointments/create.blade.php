                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-8">
                                                        ...
                                                        <small class="text-success">
                                                            <i class="bi bi-briefcase"></i> {{ $doctor->experience_years }}
                                                            years
                                                        </small>
                                                    </div>
                                                    <div class="col-4 text-end">
                                                        <strong class="text-primary-custom">
                                                            Tk {{ number_format($doctor->consultation_fee) }}
                                                        </strong>
                                                        <br>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            @error('symptoms')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="form-text text-muted">Optional: Provide details to help the doctor prepare for
                                your consultation.</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled mb-0">
                            <li class="mb-2"><i class="bi bi-check-circle text-success me-2"></i> Arrive 15 minutes
                                early</li>
                            <li class="mb-2"><i class="bi bi-check-circle text-success me-2"></i> Bring CNIC and medical
                                history</li>
                            <li class="mb-2"><i class="bi bi-check-circle text-success me-2"></i> Cancel up to 2 hours
                                before</li>
                            <li class="mb-2"><i class="bi bi-check-circle text-success me-2"></i> Payment due at
                                consultation</li>
                            <li class="mb-0"><i class="bi bi-check-circle text-success me-2"></i> Prescription available
                                after visit</li>
                        </ul>
                    </div>
                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.selectDoctor = function(doctorId) {
                ...
                const selectedCard = document.querySelector(`#doctor_${doctorId}`).closest(
                    '.doctor-compact-card');
            ...
            function loadDoctorDetails(doctorId) {
                ...
                fetch(doctorDetailsUrl, {
                    ...
                    <p class="mb-2"><strong><i class="bi bi-currency-exchange"></i> Fee:</strong><br><span class="text-primary-custom fw-bold">Tk ${parseFloat(data.consultation_fee).toLocaleString()}</span></p>
            ...
            dateInput.addEventListener('change', function() {
                ...
                if (doctorId && date) {
                    ...
                    const doctorSlotsUrl = doctorSlotsRouteTemplate.replace('__DOCTOR_ID__', doctorId) +
                        `?date=${date}`;
            ...
            function updateAppointmentSummary() {
                ...
                <p class="mb-0"><strong>Consultation Fee:</strong><br><span class="text-success fw-bold">Tk ${parseFloat(fee).toLocaleString()}</span></p>
            `;

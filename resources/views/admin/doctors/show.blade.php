        ...
        <div class="row align-items-center">
            ...
            <div class="col-md">
                ...
                <div class="d-flex flex-wrap gap-2 align-items-center">
                    <span
                        class="status-badge {{ $doctor->is_available && $doctor->user->is_active ? 'status-active' : 'status-inactive' }}">
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            <div class="stat-number">
                {{ $doctor->appointments()->where('appointment_date', '>=', now()->startOfMonth())->count() }}</div>
            <div class="stat-label">This Month</div>
        </div>
        <div class="stat-card">
            <div class="stat-number">Tk {{ number_format($doctor->consultation_fee) }}</div>
        ...
        <div class="col-lg-6">
            <div class="info-card">
                ...
                <div class="info-item">
                    ...
                    <span
                        class="info-value">{{ $doctor->date_of_birth ? $doctor->date_of_birth->format('M d, Y') : 'Not provided' }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="info-card">
                ...
                <div class="info-item">
                    ...
                    <span class="info-value">Tk {{ number_format($doctor->consultation_fee) }}</span>
                </div>
                <div class="info-item">
    ...
    <div class="info-card">
        ...
        @if ($doctor->appointments()->exists())
            ...
            <div class="text-center mt-3">
                <a href="{{ route('admin.appointments.index', ['doctor' => $doctor->id]) }}"
